 ...
 */
function myInstanceof(left, right) {
  // 确保right是函数，因为instanceof右侧需要是构造函数
  if (typeof right !== 'function') {
    throw new TypeError('Right-hand side of instanceof operator must be a function.');
  }

  // null/undefined 不是任何东西的实例，提前返回（与原生 instanceof 行为一致）
  if (left == null) {
    return false;
  }
...
console.log(myInstanceof(null, Object)); // false（与原生 null instanceof Object 一致）