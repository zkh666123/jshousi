...
Function.prototype.myapply2 = function (thisArg, argsArray) {
  ...
  const fn = Symbol("fn");
  context[fn] = this;
  // apply 的第二个参数允许为 null/undefined，等价于不传参数
  const result =
    argsArray == null ? context[fn]() : context[fn](...argsArray);
  delete context[fn];
  return result;
};
...
// 使用模拟的 apply2 方法，并传入参数数组
const introduction = introduce.myapply2(person, ['Hello', '!']);
console.log(introduction); // 输出：Hello，Kimi!